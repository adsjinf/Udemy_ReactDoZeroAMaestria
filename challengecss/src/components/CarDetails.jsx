...
import style from './CarDelails.module.css'

const CarDetails = ({brand, km, color, newCar}) => {
  return (
    <div>
        <h2 className={style.my_titulo}>Detalhes do carro</h2>
        <ul>
        <li>Marca: {brand}</li>
        <li>KM: {km}</li>
        <li>Cor: {color}</li>
...
CarDetails.propTypes = {
    ...
    newCar: PropTypes.bool.isRequired // Valida que a prop 'km' é um bool obrigatória
  };
